        ...
        {isOpen && (
          ...
          >
            ...
            <div className="relative h-full p-8 flex flex-col">
              ...
              >
                <h3 className="font-heading text-saints-gold text-2xl mb-3 bg-clip-text text-transparent bg-gradient-to-r from-saints-gold to-saints-purple">
                  Connect With Us
                </h3>
              ...
              <div className="space-y-3 flex-1">
                {socialLinks.map((link, index) => (
                  ...
                  >
                    ...
                    <span className="text-white group-hover:text-saints-gold transition-colors duration-300 font-medium relative z-10">
                      {link.name}
                    </span>
                  </motion.a>
                ))}
