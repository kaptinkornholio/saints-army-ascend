    ...
    const applyButtonEffects = () => {
      ...
      buttons.forEach(button => {
        if (!button.classList.contains('micro-enhanced')) {
          ...
          button.addEventListener('mousedown', function(e: MouseEvent) {
